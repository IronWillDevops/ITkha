...
@section('admin.content')
    <div class="flex items-center justify-between mb-6">
        <x-admin.form.action-button type="link" route="{{ route('admin.tag.create') }}" icon="fa-solid fa-plus"
            label="{{ __('admin/tags.actions.create') }}" />
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-2 text-sm  font-medium link hover:link-hover hover:underline">
                            <a href ="{{ route('admin.tag.show', $tag->id) }}"
                                class="focus:ring focus:outline-none focus-visible:ring-ring">{{ $tag->title }}</a>
                        </td>
                        ...
                        <td class="px-4 py-2 text-sm text-right space-x-2 flex justify-end">
                            ...
                            <a href="{{ route('admin.tag.edit', $tag->id) }}"
                                ...
                                title="{{ __('admin/tags.actions.edit') }}">
                            ...
                            <form action="{{ route('admin.tag.delete', $tag->id) }}" method="POST"
                                ...
                                <button type="submit"
                                    ...
                                    title="{{ __('admin/tags.actions.delete') }}">
