...
@section('public.content')
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="lg:col-span-3 space-y-6">
            <div class="space-y-10 bg-card rounded-xl border border-border shadow-lg p-6">
                <section class="session">
                    <h2 class="text-xl font-semibold text-primary mb-4">{{ __('public/user.sections.sessions') }}</h2>
                    <div class="space-y-4">
                                    ...
                                    @else
                                        <form method="POST"
                                            ...
                                            <button type="submit" title="{{ __('public/user.buttons.logout') }}"
                                                class="btn btn-danger btn-shimmer rounded-lg">
