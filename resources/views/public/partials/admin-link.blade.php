  <nav class="bg-surface  border-border flex items-center gap-6  px-4 py-2 shadow rounded border ">
      ...
      <a href="{{ route('admin.user.index') }}" class="link-text link-hover flex items-center gap-2 text-sm ">
