...
echo -e "  - DB_DATABASE (database name)"
echo -e "  - DB_USERNAME (database user)"
echo -e "  - DB_PASSWORD (database password)"
echo -e "  - APP_URL (your site URL)"
echo ""
echo -e "${GREEN}After editing .env, run:${RESET}"
echo -e "  ${GREEN}bash 2_deploy_post_migrate.sh${RESET}"
echo ""
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
echo ""